...
- Setting "Minimal TLS" by dashboard won't take effect. Cloudflare Pages is taking precedence and internally set as minimal 1.0 TLS. Solution is by using Cloudflare Worker to respond with it (@thx Patryk Padus)
